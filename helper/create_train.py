...
tokenizer = AutoTokenizer.from_pretrained('tunib/electra-ko-en-base', use_fast=True)
...
if __name__ == "__main__":
    ...
    with open(args.file, 'r', encoding='utf-8') as corpus_file:
    ...
    with open(os.path.join(args.save_to, file_name + '.json'), 'w') as tokenized_file:
        ...
        all_blocks = [encode_one_line(line) for line in lines]
